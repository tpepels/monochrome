...
- `HIFI_PROXY_ALLOWED_HOSTS`: optional comma-separated HTTPS hostnames to add to the self-hosted fallback API proxy allowlist. Monochrome's bundled public HiFi instances are allowed by default.
