...
export const apiSettings = {
    ...
    _shouldUseStaticDefaults() {
        if (typeof window === 'undefined') return false;
        const hostname = window.location?.hostname;
        return hostname !== 'monochrome.tf' && hostname !== 'www.monochrome.tf';
    },
    ...
    async loadInstancesFromGitHub() {
        ...
        this._loadPromise = (async () => {
            if (this._shouldUseStaticDefaults()) {
                this.defaultInstances = this._staticDefaultInstances();
